...
export const posts: Post[] = [
  ...
  ## Keys and Endpoints
    ...
    * Contact
    ...
    To authenticate with the app, a user would request and API key from me, but, in reality, the API was really meant for me for documentation purposes, so I created a key for myself. The user (or I) would authenticate this way:
